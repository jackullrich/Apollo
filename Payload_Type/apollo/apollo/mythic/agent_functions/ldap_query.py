    ...
    async def parse_arguments(self):
        if self.command_line[0] == "{":
            ...
            if "full_path" in data:
                ...
                dn = metadata.get("ldap_dn") or (display_path if _is_valid_dn(display_path) else None) or metadata.get("target_dn") or metadata.get("distinguishedname") or metadata.get("DistinguishedName")
